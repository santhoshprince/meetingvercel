...
AXIOS_CLIENT.interceptors.request.use(
  (config) => {
    ...
    // const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzIwNjczNTU3LCJpYXQiOjE3MjA1ODcxNTcsImp0aSI6ImQ5MjQyYTU4OGM5MjQ1NDBhMjQ2NmMyZDU3NWQ0NTgxIiwidXNlcl9pZCI6MTF9.OBBLVbJgD7BwP95AE92BHjByn0yQUiDJvsPV_E-hh58";
    if (token) {
